...
public class Fib extends FJTask {
	...
	/*
	 * public static void main(String[] args) { // sample driver try { int
	 * groupSize = 2; // 2 worker threads int num = 35; // compute fib(35)
	 * FJTaskRunnerGroup group = new FJTaskRunnerGroup(groupSize); Fib f = new
	 * Fib(num); group.invoke(f); int result = f.getAnswer();
	 * System.out.println("Answer: " + result); } catch (InterruptedException
	 * ex) {} // die }
	 */
}
